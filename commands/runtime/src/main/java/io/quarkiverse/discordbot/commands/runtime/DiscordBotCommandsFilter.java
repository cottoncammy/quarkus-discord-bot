...
@ApplicationScoped
public class DiscordBotCommandsFilter {
    private static final Logger LOGGER = Logger.getLogger(DiscordBotCommandsFilter.class);

    @Inject
    DiscordBotCommandsConfig config;

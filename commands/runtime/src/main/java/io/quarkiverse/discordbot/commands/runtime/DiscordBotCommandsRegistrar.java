...
@ApplicationScoped
public class DiscordBotCommandsRegistrar {
    private static final Logger LOGGER = Logger.getLogger(DiscordBotCommandsRegistrar.class);
    ...
    public void register(@Observes StartupEvent startup, GatewayDiscordClient gateway, DiscordBotCommandsConfig config) {
